...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_QWERTY] = LAYOUT_5x6(
        ...
        KC_BSPC, LT(RAISE,KC_A)  , KC_S  , LT(LOWER,KC_D)  , KC_F  , KC_G  ,                                    KC_H  , KC_J  , LT(LOWER,KC_K)  , KC_L  ,LT(RAISE,KC_SCLN),KC_QUOT,
    ...
    [_LOWER] = LAYOUT_5x6(
        ...
        _______,_______,_______,_______,_______,_______,                        _______, KC_KB_MUTE , _______ , _______ ,_______ ,_______,
                                                _______,_______,            _______, _______,
                                                _______,_______,            KC_KB_VOLUME_DOWN,KC_KB_VOLUME_UP,
                                                _______,_______,            _______,_______,
                                                _______,_______,            _______,_______
